...
<div class="container-fluid text-center bg-light" style="margin-top: 10em">
  <p style="font-size:50px ">HELLO, Teacher</p>
  ...
  <a href="teacherregister.php"><button class="btn btn-primary" >Apply For Job</button></a>
  <a href="teacherlogin.php"><button class="btn btn-primary" >Login</button></a>
