...
<body>
<?php
  $save = mysqli_query($db , "SELECT * FROM teacher  WHERE approved='false' ");

  echo "<table class='table text-center' style='width: 60%; left: 25%'>";
  echo "<tr class='bg-primary'>";
  echo "<th colspan='7'>Teachers</th>";
  echo "</tr>";
  ...
  echo "<tr>
          ...
          <td> <a class='btn btn-primary fa fa-check-circle 'name='submit' href='approve.php?id=".$retrive['id']." '></a> </td>
          <td> <a class='btn btn-danger fas fa-trash' href='deleteteacher.php?id=".$retrive['id']." '></a> </td>
      </tr>";
  }
  echo "</table>";
