 ...
 $user_check_query = "SELECT * FROM student WHERE username='$username'  LIMIT 1 ";
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO student (username,password_1,firstname,lastname,schoolfee,mobile,class,approved)
           VALUES('$username','$password','$firstname','$lastname','$schoolfee',$mobile,'$class','true')";
...
<body>
        <div class="container form-inline" >
            <form action="" method="post">
                      <p class="bg-primary text-center">Register New Student To School</p> <br>
                ...
                <div class="form-group">
                      ...
                      <input type="text" class="form-control m-2" name="schoolfee" placeholder="schoolfee" style="padding-right:3em;padding-left: 2em">
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                      ...
                      <input type="text" class="form-control m-2" name="class" placeholder="Class" style="padding-right:3em;padding-left: 2em">
                </div>
                <center>
                    <button type="submit" name="reg_student" id="reg_student" class="btn btn-primary" style="width: 30%; padding: 1em" >Hire</button>
                </center>
            </form>
        </div>
