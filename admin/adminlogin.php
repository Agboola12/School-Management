...
<body>
  ...
  <ul class="navbar-nav list-line">               
    ...
    <li class="nav-item dropdown list-line-item mr-5 " >
      <a href="first.php" class="nav-link">Admin</a>
    </li>
    <li class="nav-item dropdown  list-line-item mr-5" >
...
<!-- <div class="container jumbotron card form inline" id="login" style="top: 2em">
    
</div> -->
<div class="container jumbotron card form-inline" style="top: 9em; border-radius: 50px" >
            <form action="" method="post">
              <?php include ('../errors.php') ?>
                      <p class="bg-primary text-center text-light h5" style="padding: 1em; border-radius: 20px">Login</p> <br>
                ...
                <center>
                    <button type="submit" name="login_admin" id="login_admin" class="btn btn-primary" style="width: 30%; padding: 1em" >Hire</button>
                </center>
            </form>
        </div>
