...
<div class="container jumbotron card form-inline" style="top: 6em; border-radius: 50px" >
            <form action="" method="post"  enctype="multipart/form-data">
               <p class="bg-primary text-center" style="padding: 1em">Sign Up</p> <br>
                ...
                <div class="form-group">
                      ...
                      <input type="file" class="form-control m-2" name="pix">
                </div>
                <center>
                    <input type="submit" name="reg_admin" id="reg_admin" class="btn btn-primary" style="width: 30%; padding: 1em" value="Hire">
                </center>
            </form>
        </div>
