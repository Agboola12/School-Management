          ...
          <div class="" style=" width: 50%; margin-left: 50px; ">
              <div class="col-md-6"   >
                <input type="hidden" name="id"  class="form-control" value="<?php echo $id; ?>" style="width: 500px"  >
                    ...
                    <div class="m-3">    
                        <h6  class="" >School Fee</h6>
                        <input type="text" name="schoolfee" class="form-control" value="<?php echo $schoolfee; ?>" style="width: 500px" > 
                    </div>
                    <div class="m-3" style=" "> 
                        <h6 class="">Mobile</h6>
                    ...
                    <div class="m-3" style=" "> 
                        <h6 class="">class</h6>
                        <input type="text" name="class" class="form-control" value="<?php echo $class; ?>" style="width: 500px" >  
                    </div>   
              </div>
          </div>
             <div class="col-md-1" >
