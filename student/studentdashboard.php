 ...
 <body>
      <div class="container text-center" style="left: 5em" >
             ...
             <span>  
              ...
              <span>                  
                    <?php 
                     ...
                     //  $approve = mysqli_query($db , "SELECT * FROM student  WHERE approved='true' " );
        ...
        <div class="btn-group ml-5" id="add" style="width: 190px">
          <button type="button" class="btn btn-success">Mobile <br><br>
                <span><i class="fas fa-mobile"></i></span>
                  <span>                  
                    <?php
                        echo $mobile; 
                     //  $app = mysqli_query($db , "SELECT * FROM student  WHERE approved='true' " );
          ...
          <div class="btn-group ml-5" style="width: 190px">
            <button type="button" class="btn btn-warning">Class <br><br> 
        ...
        <div class="btn-group ml-5" style="width: 190px">
          <button type="button" class="btn btn-danger">School Fee<br><br>
...
<?php     
 $save = mysqli_query($db , 'SELECT * FROM admin_notice ');
  ...
  echo "<a href='delete.php?id=".$retrive['notice_id']." '><i class='fas fa-times text-light h5' style='float:right'></i> </a>" ;
  }
?>
</div>
  </div>
