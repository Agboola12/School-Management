...
<div class="container jumbotron card form-inline" style="top: 6em; border-radius: 50px" >
            <form action="" method="post"  enctype="multipart/form-data">
               <p class="bg-primary text-center" style="padding: 1em">New Admission To School</p> <br>
                ...
                <center>
                    <input type="submit" name="reg_student" id="reg_student" class="btn btn-primary mt-3" style="width: 30%; padding: 1em" value="Take Admission">
                </center>
            </form>
        </div>
